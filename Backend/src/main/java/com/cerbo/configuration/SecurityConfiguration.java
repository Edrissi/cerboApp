...
import com.cerbo.utils.RSAKeyProperties;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.addFilterBefore(new JwtTokenValidationFilter(blackListJwtService), UsernamePasswordAuthenticationFilter.class);
        return http.build();
    }
