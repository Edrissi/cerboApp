...
const Hero = () => {
  return (
    <div className="hero bg-gradient-to-r from-purple-800 to-purple-600 bg-cover bg-center h-screen w-screen flex items-center justify-center" style={{backgroundImage: "linear-gradient(rgba(8, 0, 58, 0.7), rgba(8, 0, 58, 0.7)), url('/src/img/Hero.jpg')"}}>
